...
class Room(Base):
    ...
    unavailability_start: Mapped[date] = mapped_column("unavailability_start", nullable=True)
    unavailability_end: Mapped[date] = mapped_column("unavailability_end", nullable=True)
